...
[![Version](https://img.shields.io/badge/version-2.0.0-green.svg)](src/constants.js)
...
| History chart | Background sparkline, points spaced by real elapsed time; min/max/period labels; fill zones colored by threshold (clipPath, not gradient); hover/tap a point for its exact value; "No numeric history" note instead of a silent blank area for the wrong entity domain |
